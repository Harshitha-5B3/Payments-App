...
CREATE TABLE transactions (
    ...
    `customer_name` VARCHAR(4) default NULL,
    `receiver_id` VARCHAR(4) default NULL,
    `receiver_name` VARCHAR(4) default NULL,
    `receiver_bname` VARCHAR(4) default NULL,
    `message_code` VARCHAR(4) default NULL,
    `transfer_type` VARCHAR(4) default NULL,
    `timestamp` VARCHAR(4) default NULL,
